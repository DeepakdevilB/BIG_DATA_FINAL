...
const dashboardLink = document.querySelector('.nav-link.active'); // Add this line
...
const setupEventListeners = () => {
  ...
  // Dashboard link click - refresh items
  dashboardLink.addEventListener('click', (e) => {
    e.preventDefault();
    // Hide the Hadoop export result if it's visible
    hadoopExportResult.classList.add('d-none');
    // Reload items from the API
    loadItems();
